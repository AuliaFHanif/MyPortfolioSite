...
const HeroBanner = () => {
  return (
    <div className="bg-linear-to-r from-purple-300 via-pink-300 to-yellow-300 border-4 border-black p-8 shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] relative overflow-hidden">
      {/* Decorative elements */}
      ...
      <div className="flex flex-col md:flex-row items-center gap-8 relative z-10">
        ...
        <div className="relative">
          <div className="w-48 h-48 md:w-64 md:h-64 border-4 border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] bg-white overflow-hidden relative">
            <div className="w-full h-full bg-linear-to-br from-blue-200 to-pink-200 flex items-center justify-center">
        ...
        <div className="flex-1 text-center md:text-left">
          <div className="bg-white/80 backdrop-blur-sm border-2 border-black p-6 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
            <h2 className="text-4xl md:text-5xl font-bold mb-3 flex items-center justify-center md:justify-start gap-2 flex-wrap">
              HELLO, I&apos;M FARHAN! 
              <span className="text-2xl font-normal text-gray-500 ml-2">ファーハンです</span>
            ...
            <div className="space-y-3">
              ...
              <div className="flex flex-wrap gap-2 justify-center md:justify-start pt-2">
                ...
                <span className="bg-green-200 border-2 border-black px-3 py-1 text-sm font-bold">Sequelize</span>
              </div>
            </div>
          </div>
        </div>
